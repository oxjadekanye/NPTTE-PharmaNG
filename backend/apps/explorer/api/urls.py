...
from apps.explorer.api.views import (
    ...
    ExplorerQuickActionsView,
    ExplorerQuickBundleView,
    ExplorerQuickRecordsView,
    ExplorerQuickSummaryView,
...
urlpatterns = [
    ...
    path("quick-bundle/", ExplorerQuickBundleView.as_view(), name="explorer-quick-bundle"),
    path("quick-summary/", ExplorerQuickSummaryView.as_view(), name="explorer-quick-summary"),
    path("quick-records/", ExplorerQuickRecordsView.as_view(), name="explorer-quick-records"),
    path("quick-actions/", ExplorerQuickActionsView.as_view(), name="explorer-quick-actions"),
