    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('national_id_number', models.CharField(blank=True, db_index=True, help_text='National identification reference (e.g. NIN) where applicable.', max_length=64)),
                ('is_regulator', models.BooleanField(default=False, help_text='Quick flag for regulator-facing access; refined via RBAC later.')),
